                ...
                <tr key={farm.id} className="hover:bg-gray-50 transition-colors">
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center">
                      <div className="h-8 w-8 bg-gradient-to-r from-blue-500 to-emerald-500 rounded-full flex items-center justify-center">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{farm.areaHa}</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{farm.owner}</td>
